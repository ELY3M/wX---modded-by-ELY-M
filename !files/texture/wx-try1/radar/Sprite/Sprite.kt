...
class Sprite : Rectangle {
    ...
    val uvb = ByteBuffer.allocateDirect(UV.size * 4)
    protected var mUVBuffer: FloatBuffer = uvb.asFloatBuffer()

    protected var mBitmap: Bitmap

    protected var mTexCoordLoc: Int = 0
    protected var mSamplerLoc: Int = 0
