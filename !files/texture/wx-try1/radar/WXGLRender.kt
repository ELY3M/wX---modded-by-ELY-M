...
import joshuatee.wx.radar.Sprite.Sprite
...
class WXGLRender(private val context: Context) : Renderer {
    ...
    //todo textures
    protected val DEFAULT_BG_COLOR = Color.argb(255, 0, 0, 0)
    protected var mClearColor: Int = 0
    ...
    @Volatile
    protected var mCameraX = 0f
    @Volatile
    protected var mCameraY = 0f
    @Volatile
    protected var mCameraZ = 0f

    protected var mWidth: Int = 0
    protected var mHeight:Int = 0
    protected var mAspectRatio: Float = 0.toFloat()

    var locationbitmap: Bitmap = UtilityTexture.LoadBitmap(MyApplication.FilesPath+"location.png")
    var starbitmap: Bitmap = UtilityTexture.LoadBitmap(MyApplication.FilesPath+"testcyan.png")

    var locationsprite: Sprite= Sprite(-.25f, .75f, .25f, .25f, locationbitmap);
    var starsprite: Sprite = Sprite(200f, 200f, 2500f, 2500f, starbitmap);

    //textures
    //var locationtexture: Int = 0
    //var startexture: Int = 0
    ...
    override fun onSurfaceCreated(gl: GL10, config: EGLConfig) {
        ...
        //TODO testing
        //locationtexture = UtilityTexture.LoadTexture(gl, MyApplication.FilesPath+"location.png")
        //startexture = UtilityTexture.LoadTexture(gl, MyApplication.FilesPath+"star_cyan.png")
    }
    ...
    * */
    ...
    override fun onSurfaceChanged(gl: GL10, width: Int, height: Int) {
        ...
        mWidth = width
        mHeight = height
        mAspectRatio = width.toFloat() / height
        Matrix.frustumM(mProjectionMatrix, 0, -mAspectRatio, mAspectRatio, -1f, 1f, 3f, 7f)
