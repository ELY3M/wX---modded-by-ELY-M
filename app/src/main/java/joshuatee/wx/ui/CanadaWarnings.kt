...
class CanadaWarnings(private val activity: Activity, private val box: VBox, private val toolbar: Toolbar) {

    private var listLocUrl = listOf<String>()
    private var listLocName = listOf<String>()
    private var listLocWarning = listOf<String>()
    private var listLocWatch = listOf<String>()
    private var listLocStatement = listOf<String>()
    ...
    fun showData() {
        ...
        box.addWidget(Image(activity, toolbar, bitmap))
        ...
        listLocUrl.indices.forEach { index ->
            ...
            val cardText = CardText(activity)
        ...
        CanadaLegal(activity, box, GlobalVariables.canadaEcSitePrefix + "/warnings/index_e.html")
    }
