...
class SpottersActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fab = ObjectFab(this, this, R.id.fab_fav)
        val fab2 = ObjectFab(this, this, R.id.fab_map)
        val fab3 = ObjectFab(this, this, R.id.fab_radar)
        val fab4 = ObjectFab(this, this, R.id.fab_reports)
        fab.setOnClickListener(View.OnClickListener { toggleMode(ActionMode.FAV) })
        fab2.setOnClickListener(View.OnClickListener { toggleMode(ActionMode.MAP) })
        fab3.setOnClickListener(View.OnClickListener { toggleMode(ActionMode.RADAR) })
        fab4.setOnClickListener(View.OnClickListener { reportFAB() })
