...
internal object UtilityWPCImages {
    ...
    val urls = listOf(
            ...
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_12_fcst.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_24_fcst.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_36_fcst.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_48_fcst.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_60_fcst.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_mid_072.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_mid_096.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_mid_120.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_mid_144.gif",
            "${MyApplication.nwsAWCwebsitePrefix}/adds/data/progs/hpc_mid_168.gif",
