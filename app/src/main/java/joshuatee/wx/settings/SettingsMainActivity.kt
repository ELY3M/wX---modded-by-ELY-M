...
class SettingsMainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        linearLayout.addView(ObjectSettingsCheckBox(this, this, "Check for TOR,TST,FFW,SMW,SPS", "CHECKTOR", R.string.checktor_switch_label).card)
