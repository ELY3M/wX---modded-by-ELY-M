	...
	//elys mod
        ...
        box.addWidget(
                ObjectNumberPicker(
                        ...
                        UIPreferences.animationIntervalDefault,
                        1,
                        15
                ).get()
        )
	...
	//elys mod //radar legends settings//
        box.addWidget(
                ObjectNumberPicker(
                        this,
                        "Color Legend width",
                        "RADAR_SHOW_LEGEND_WIDTH",
                        R.string.showlegendwidth,
                        50,
                        1,
                        100
                ).get()
        ...
        box.addWidget(
                ObjectNumberPicker(
                        ...
                        "RADAR_SHOW_LEGEND_TEXTSIZE",
                        R.string.showlegendtextsize,
                        30,
                        1,
                        100
                ).get()
	...
	//elys mod
        ...
        box.addWidget(
                ObjectNumberPicker(
                        ...
                        RadarPreferences.radarAviationSizeDefault,
                        1,
                        50
                ).get()
        )
	...
	//elys mod
		box.addWidget(
                ObjectNumberPicker(
                        ...
                        "RADAR_HI_TEXT_SIZE",
                        R.string.hi_size_np,
                        (RadarPreferences.radarHiTextSize * 10).toInt(),
                        1,
                        20
                ).get()
        )
	...
	box.addWidget(
        ...
        box.addWidget(
                ObjectNumberPicker(
                        ...
                        RadarPreferences.radarWatchMcdLineSizeDefault,
                        1,
                        10
                ).get()
        )
        ...
        box.addWidget(
                ObjectNumberPicker(
                        ...
                        RadarPreferences.radarSpotterSizeDefault,
                        1,
                        50
                ).get()
        )
        ...
        box.addWidget(
                ObjectNumberPicker(
                        ...
                        (RadarPreferences.radarTextSizeDefault * 10).toInt(),
                        4,
                        40
                ).get()
        )
	...
	//elys mod
        ...
        box.addWidget(
                ObjectNumberPicker(
                        ...
                        RadarPreferences.radarWarnLineSizeDefault,
                        1,
                        10
                ).get()
        )
        ...
        box.addWidget(
                ObjectNumberPicker(
                        ...
                        RadarPreferences.wxoglSizeDefault,
                        5,
                        25
                ).get()
        )
