...
class SettingsRadarActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ll.addView(ObjectSettingsCheckBox(this, this, "Location auto refresh", "LOCATION_AUTOREFRESH", R.string.locationautorefresh_label).card)
        ll.addView(ObjectSettingsCheckBox(this, this, "Keep screen on", "KEEP_SCREEN_ON", R.string.keepscreenon_label).card)
        ...
        ll.addView(ObjectSettingsNumberPicker(this, this, "GPS Location icon size", "RADAR_LOCICON_SIZE", R.string.locicon_size_np, 75, 1, 530).card)
