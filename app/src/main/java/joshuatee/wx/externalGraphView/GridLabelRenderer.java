...
public class GridLabelRenderer {
    ...
    public static final class Styles {
         ...
         */
        final VerticalLabelsVAlign verticalLabelsVAlign = VerticalLabelsVAlign.MID;
    }
     ...
     */
    private final boolean mHumanRoundingY;
     ...
     */
    private final boolean mHumanRoundingX;
    ...
    protected boolean adjustVerticalSecondScale() {
        ...
        if (mStepsVerticalSecondScale != null && mStepsVerticalSecondScale.size() > 1) {
            ...
            // steps are included (divide to have more, or multiply to have less)
