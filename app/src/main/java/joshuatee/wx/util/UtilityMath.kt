...
object UtilityMath {
    ...
    fun computeMidPoint(x0: Double, y0: Double, x1: Double, y1: Double, fraction: Double): List<Double> =
    ...
    private val windDirections = listOf("N", "NNE", "NE", "ENE", "E", "ESE", "SE", "SSE", "S", "SSW", "SW", "WSW", "W", "WNW", "NW", "NNW", "N")
