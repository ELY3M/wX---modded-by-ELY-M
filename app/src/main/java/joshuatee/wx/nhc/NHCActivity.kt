...
class NhcActivity : BaseActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.action_epac_7daily -> Route.image(this, "${GlobalVariables.nwsNhcWebsitePrefix}/tafb/sst_loop/14_pac.png", "EPAC 7-Day Analysis")
            R.id.action_atl_7daily -> Route.image(this, "${GlobalVariables.nwsNhcWebsitePrefix}/tafb/sst_loop/14_atl.png", "ATL 7-Day Analysis")
            R.id.action_epac_sst_anomaly -> Route.image(this, "${GlobalVariables.nwsNhcWebsitePrefix}/tafb/sst_loop/14_pac_anom.png", "EPAC SST Anomaly")
            R.id.action_atl_sst_anomaly -> Route.image(this, "${GlobalVariables.nwsNhcWebsitePrefix}/tafb/sst_loop/14_atl_anom.png", "ATL SST Anomaly")
