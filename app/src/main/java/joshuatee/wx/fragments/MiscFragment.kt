...
class MiscFragment : Fragment() {
    ...
    private val allItemList: MutableList<TileObject>
        get() {
            ...
            hm["uswarn"] = TileObject(R.drawable.warn, USWarningsWithRadarActivity::class.java, USWarningsWithRadarActivity.URL, arrayOf(".*?Tornado Warning.*?|.*?Severe Thunderstorm Warning.*?|.*?Flash Flood Warning.*?|.*?Special Marine Warning.*?|.*?Special Weather Statement.*?", "us"),
