...
class ImagesFragmentGOES : Fragment() {
    ...
    private val allItemList: MutableList<TileObject>
        get() {
            val nw = TileObject(
                R.drawable.nw_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "nw", "tab"),
                resources.getString(R.string.help_goes_image_browser), "nw"
            )
            hm["nw"] = nw
            val np = TileObject(
                R.drawable.np_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "np", "tab"),
                resources.getString(R.string.help_goes_image_browser), "np"
            )
            hm["np"] = np
            val gl = TileObject(
                R.drawable.gl_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "gl", "tab"),
                resources.getString(R.string.help_goes_image_browser), "gl"
            )
            hm["gl"] = gl
            val ne = TileObject(
                R.drawable.ne_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "ne", "tab"),
                resources.getString(R.string.help_goes_image_browser), "ne"
            )
            hm["ne"] = ne
            val wc = TileObject(
                R.drawable.wc_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "wc", "tab"),
                resources.getString(R.string.help_goes_image_browser), "wc"
            )
            hm["wc"] = wc
            val cp = TileObject(
                R.drawable.cp_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "cp", "tab"),
                resources.getString(R.string.help_goes_image_browser), "cp"
            )
            hm["cp"] = cp
            val mw = TileObject(
                R.drawable.mw_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "mw", "tab"),
                resources.getString(R.string.help_goes_image_browser), "mw"
            )
            hm["mw"] = mw
            val ma = TileObject(
                R.drawable.ma_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "ma", "tab"),
                resources.getString(R.string.help_goes_image_browser), "ma"
            )
            hm["ma"] = ma
            val sw = TileObject(
                R.drawable.sw_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "sw", "tab"),
                resources.getString(R.string.help_goes_image_browser), "sw"
            )
            hm["sw"] = sw
            val sc = TileObject(
                R.drawable.sc_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "sc", "tab"),
                resources.getString(R.string.help_goes_image_browser), "sc"
            )
            hm["sc"] = sc
            val se = TileObject(
                R.drawable.se_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "se", "tab"),
                resources.getString(R.string.help_goes_image_browser), "se"
            )
            hm["se"] = se
            val pr = TileObject(
                R.drawable.pr_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "pr", "tab"),
                resources.getString(R.string.help_goes_image_browser), "pr"
            )
            hm["pr"] = pr
            val hi = TileObject(
                R.drawable.hi_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "hi", "tab"),
                resources.getString(R.string.help_goes_image_browser), "hi"
            )
            hm["hi"] = hi
            val ak = TileObject(
                R.drawable.ak_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "ak", "tab"),
                resources.getString(R.string.help_goes_image_browser), "ak"
            )
            hm["ak"] = ak
            val epac = TileObject(
                R.drawable.epac_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "epac", "tab"),
                resources.getString(R.string.help_goes_image_browser), "epac"
            )
            hm["epac"] = epac
            val watl = TileObject(
                R.drawable.watl_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "watl", "tab"),
                resources.getString(R.string.help_goes_image_browser), "watl"
            )
            hm["watl"] = watl
            val weus = TileObject(
                R.drawable.weus_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "weus", "tab"),
                resources.getString(R.string.help_goes_image_browser), "weus"
            )
            hm["weus"] = weus
            val ceus = TileObject(
                R.drawable.ceus_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "ceus", "tab"),
                resources.getString(R.string.help_goes_image_browser), "ceus"
            )
            hm["ceus"] = ceus
            val eaus = TileObject(
                R.drawable.eaus_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "eaus", "tab"),
                resources.getString(R.string.help_goes_image_browser), "eaus"
            )
            hm["eaus"] = eaus
            val nhem = TileObject(
                R.drawable.nhem_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "nhem", "tab"),
                resources.getString(R.string.help_goes_image_browser), "nhem"
            )
            hm["nhem"] = nhem
            val nepac = TileObject(
                R.drawable.nepac_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "nepac", "tab"),
                resources.getString(R.string.help_goes_image_browser), "nepac"
            )
            hm["nepac"] = nepac
            val e = TileObject(
                R.drawable.e_epac_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "e", "tab"),
                resources.getString(R.string.help_goes_image_browser), "e"
            )
            hm["e"] = e
            val carb = TileObject(
                R.drawable.carb_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "carb", "tab"),
                resources.getString(R.string.help_goes_image_browser), "carb"
            )
            hm["carb"] = carb
            val nwatl = TileObject(
                R.drawable.nwatl_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "nwatl", "tab"),
                resources.getString(R.string.help_goes_image_browser), "nwatl"
            )
            hm["nwatl"] = nwatl
            val watl2 = TileObject(
                R.drawable.watl_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "watl", "tab"),
            ...
            hm["watl2"] = watl2
            val gmex = TileObject(
                R.drawable.gmex_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "gmex", "tab"),
                resources.getString(R.string.help_goes_image_browser), "gmex"
            )
            hm["gmex"] = gmex
            val catl = TileObject(
                R.drawable.catl_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "catl", "tab"),
                resources.getString(R.string.help_goes_image_browser), "catl"
            )
            hm["catl"] = catl
            val natl = TileObject(
                R.drawable.natl_sm, USNWSGOESActivity::class.java, USNWSGOESActivity.RID,
                arrayOf("nws", "natl", "tab"),
                resources.getString(R.string.help_goes_image_browser), "natl"
            )
            hm["natl"] = natl
            val tileOrder =
                "nw:np:gl:ne:wc:cp:mw:ma:sw:sc:se:pr:hi:ak:epac:watl:weus:ceus:eaus:nhem:nepac:e:carb:nwatl:watl2:gmex:catl:natl:"
            val tileOrderArr =
                MyApplication.colon.split(Utility.readPref("FRAGMENT_IMGGOES_ORDER", tileOrder))
            return tileOrderArr
                .filterNot {
